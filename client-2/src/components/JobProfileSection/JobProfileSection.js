...
import './index.css';
import JobFilterGroup from "../JobFilterGroup/JobFilterGroup";
...
const JobProfileSection = () => {
  ...
  const getJobDetails = async () => {
    ...
    const url = `http://localhost:6600/api/filterjobs?employment_type=${employementType.join()}&minimum_package=${salaryRange}&search=${searchInput}`;
    const options = {
      headers: {
