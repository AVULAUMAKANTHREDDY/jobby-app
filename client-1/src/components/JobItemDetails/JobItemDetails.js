...
import Header from "../Header/Header";
 import SimilarJobItem from '../SimilarJobDetails/SimilarJobDetails';
...
const JobItemDetails =()=>{
    ...
    const getJobDetails = async ()=>{
        ...
        // const url = `http://localhost:4523/api/jobs/${_id}`;
        const url = `http://localhost:4523/api/jobs/${id}`
        const oprtions = {
            headers:{
    ...
    const renderLoaderView = () => {
      ...
      const renderJobItemDetails = ()=>{
        const {company_logo_url, company_website_url,employment_type,job_description,lifeAtCompany,location,package_per_annum,rating,skills,title} = jobItemDeatils
        ...
        <div className="job-items-container">
          ...
          <div className="description-container">
            ...
            <a className="visit-link" href={company_website_url} target="_blank" >
              Visit
